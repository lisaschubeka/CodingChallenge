...
interface CreateSegmentUseCase {
    ...
    fun createPIDSegment(stringSegment: List<String>, mshId: Long): PIDSegment
    fun createOBXSegment(stringSegment: List<String>, mshId: Long): OBXSegment
    fun createNTESegment(stringSegment: List<String>, obxId: Long): NTESegment
}